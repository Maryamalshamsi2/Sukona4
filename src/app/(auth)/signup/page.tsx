          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                autoComplete="name"
                className="block w-full rounded-xl bg-[#F2F2F7] px-4 py-3 text-body transition-colors focus:bg-[#EBEBF0] focus:outline-none focus:ring-2 focus:ring-primary-200/60 sm:py-2.5 sm:text-body-sm"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="block w-full rounded-xl bg-[#F2F2F7] px-4 py-3 pr-10 text-body transition-colors focus:bg-[#EBEBF0] focus:outline-none focus:ring-2 focus:ring-primary-200/60 sm:py-2.5 sm:text-body-sm"
                />
                <button
                  type="button"
