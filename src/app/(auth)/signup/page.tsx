          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="overflow-hidden rounded-xl bg-[#F2F2F7]">
              <div className="px-4 py-3 transition-colors focus-within:bg-black/[0.025]">
                <label htmlFor="full_name" className="block text-caption font-medium text-text-tertiary">
                  Full Name
                </label>
                <input
                  id="full_name"
            ...
            <div className="overflow-hidden rounded-xl bg-[#F2F2F7]">
              <div className="px-4 py-3 transition-colors focus-within:bg-black/[0.025]">
                <label htmlFor="email" className="block text-caption font-medium text-text-tertiary">
                  Email
                </label>
                <input
                  id="email"
            ...
            <div>
              <div className="overflow-hidden rounded-xl bg-[#F2F2F7]">
                <div className="px-4 py-3 transition-colors focus-within:bg-black/[0.025]">
                  <label htmlFor="phone" className="block text-caption font-medium text-text-tertiary">
                    Phone
                  </label>
                  <PhoneInput value={phone} onChange={setPhone} required variant="ios" />
                </div>
              </div>
